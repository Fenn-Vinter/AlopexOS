# LICENSE.md / Intellectual Property, Governance & Licensing Model

## 1. Project Director Jurisdiction & Proprietary Ownership
All code, documentation, designs, binaries, and assets comprising AlopexOS remain the exclusive copyrighted property of the Project Director—defined as **Fenn Vinter** (legal name: Sondre Rasmussen) or **AurenFox.Studio**, with Fenn Vinter holding supreme and ultimate authority. This structure guarantees that regardless of corporate restructuring, acquisition, dissolution, or the loss of the entity (AurenFox.Studio), all intellectual property rights, ownership, and governance over AlopexOS remain securely vested in Fenn Vinter.
...
External contributions from independent developers are welcome under strict contributor terms:
* All accepted contributions are fully assigned to the Project Director upon submission to ensure centralized legal ownership and prevent fragmented rights.
* Contributors will be formally acknowledged and credited in the official AlopexOS credits documentation.
* Outstanding contributors may be invited to join the core AlopexOS development team at AurenFox.Studio.

## 5. Contributor Warranty & Originality
Every developer contributing code or assets to AlopexOS warrants and certifies that their work is original, free of third-party proprietary claims, and adheres strictly to project standards (including the ban on unauthorized third-party tools).
